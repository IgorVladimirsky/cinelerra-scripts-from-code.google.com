...
# and puts the output in ../standard-mpeg-for-dvd
# 
...
nice ffmpeg -i $filenamewithoutextension.m2ts -aspect 16:9 -s 720x576 -b 9040k -maxrate 9050k -target pal-dvd -y ../standard-mpeg-for-dvd/$filenamewithoutextension.mpeg
